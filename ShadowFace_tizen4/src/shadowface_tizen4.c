...
create_base_gui (appdata_s *ad, int width, int height)
{
  ...
  for (int i = 0; i < 60; i++) {
	  ...
	  evas_object_anti_alias_set (ad->ticks[i / 5], true);
      ...
      evas_object_anti_alias_set (ad->ticks[i], 0);
    }
  ...
  evas_object_anti_alias_set (ad->hand_hour, 0);
  ...
  //evas_object_move (ad->hand_hour, (width / 2) - 2, GeneralGap);
  evas_object_color_set (ad->hand_hour, 200, 200, 200, 120);
  evas_object_anti_alias_set (ad->hand_hour, true);
  evas_object_show (ad->hand_hour);*/
  ...
  evas_object_anti_alias_set (ad->hand_minute, 0);
  ...
  evas_object_anti_alias_set (ad->hand_minute_battery, 0);
  ...
  if (img_path != NULL) {
      ...
      evas_object_image_file_set (ad->hand_second, img_path, NULL);
      //evas_object_image_filled_set(ad->hand_second, img_path);
      evas_object_move (ad->hand_second, (width / 2) - 7, GeneralGap);
      evas_object_resize (ad->hand_second, 15, 15);
      evas_object_show (ad->hand_second);
      free (img_path);
    }
